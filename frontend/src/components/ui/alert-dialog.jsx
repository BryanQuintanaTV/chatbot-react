...
const AlertDialog = React.forwardRef(({ onOpenChange, ...props }, ref) => (
  <AlertDialogPrimitive.Root onOpenChange={onOpenChange} {...props} ref={ref} />
))
...
const AlertDialogContent = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      onEscapeKeyDown={(e) => {
        // Allow closing on Escape by not preventing default
      }}
      onPointerDownOutside={(e) => {
        // Allow closing when clicking outside by not preventing default
      }}
      {...props} />
  </AlertDialogPortal>
))
